...
export class AdvancedSearchComponent implements OnInit {
  ...
  returnSearch(advanceSearch: advancedSearch): advancedSearch {
    ...
    if (this.hasOneEmployee && this.advancedForm.value.employeeId != null) {
      advanceSearch.employeeIds = this.advancedForm.value.employeeId;
    } else {
      if (this.hasTeams) {
  ...
  onFillSearch() {
    ...
    if (this.hasOneEmployee && this.advancedForm.value.employeeId != null) {
      this.advanceSearch.employeeIds = this.advancedForm.value.employeeId;
    } else {
...
//console.log(this.advanceSearch)
  ...
  onEmployeeCancel() {
    ...
    this.advanceSearch.employeeIds = null;
  }
