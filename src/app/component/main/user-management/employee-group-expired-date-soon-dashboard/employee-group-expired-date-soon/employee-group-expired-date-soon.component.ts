...
@Component({
  selector: 'app-employee-group-expired-date-soon',
  templateUrl: './employee-group-expired-date-soon.component.html',
  styleUrls: ['./employee-group-expired-date-soon.component.scss']
})


export class EmployeeGroupExpiredDateSoonComponent extends BaseEditComponent {
  model: any = {};
  id: string;
  groups:any[];
  url = 'EmployeeGroups/GetAllPagedEmployeeGroupExpireThroughWeekDashBoard';
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EmployeeGroupExpiredDateSoonComponent>,
